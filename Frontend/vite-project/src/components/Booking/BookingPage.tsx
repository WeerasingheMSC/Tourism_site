...
import CustomerVehicleBookingTable from "./CustomerVehicleBookingTable";
  ...
  return (
    <div className=" min-h-screen flex flex-col relative z-10 pt-20">
      ...
      <main className="max-w-7xl mx-auto w-full px-2 sm:px-6 lg:px-8 pt-12 pb-12 flex-1">
        ...
        <h2 className="text-2xl font-bold text-gray-900 mb-1 mt-8">Vehicle Booking</h2>
        <p className="text-gray-500 mb-4">View all your vehicle bookings here</p>
        <div className="rounded-2xl border border-gray-300 overflow-hidden bg-white">
          <CustomerVehicleBookingTable />
        </div>
        {/* Pagination */}
        <div className="flex justify-center mt-6">
          <nav className="flex gap-2">
            <button className="w-8 h-8 rounded-full bg-blue-50 text-blue-600 font-semibold">
              1
            </button>
            <button className="w-8 h-8 rounded-full text-gray-600 hover:bg-blue-50">
              2
            </button>
            <button className="w-8 h-8 rounded-full text-gray-600 hover:bg-blue-50">
              3
