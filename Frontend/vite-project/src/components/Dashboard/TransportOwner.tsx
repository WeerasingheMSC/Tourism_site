      ...
      <div className="flex">
        ...
        <div className="w-64 min-h-screen bg-white shadow-lg">
          ...
          <nav className="mt-6">
            ...
            <button
              onClick={handleVehicleDashboard}
              className="w-full flex items-center px-6 py-3 text-left transition-colors duration-200 text-green-600 hover:bg-green-50 hover:text-green-900 border-l-4 border-green-500"
            >
              <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
