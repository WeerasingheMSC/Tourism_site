                ...
                <div className="mb-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {amenities.map((tag, idx) => (
                      <span
                        key={idx}
                        className="px-2 py-1 bg-white/40 backdrop-blur-sm rounded-full text-sm font-medium text-gray-800"
                      >
                        {tag}
                      </span>
                    ))}
                ...
                >
                  <div className="flex items-start gap-3 mb-3">
                    <div className="w-12 h-12 bg-gray-300 rounded-full overflow-hidden flex-shrink-0">
                      <span className="text-lg leading-none text-gray-700 flex items-center justify-center h-full">
            ...
            <div className="space-y-6">
              ...
              {policies.childrenAndBeds && (
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <div className="flex justify-between">
                      <span className="font-medium">Children & Beds</span>
                      <span className="text-gray-600">
                        {policies.childrenAndBeds}
                      </span>
                    </div>
