      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl font-bold text-gray-900">Our Best Packages</h2>
          </div>
          <div className="grid md:grid-cols-3 gap-8 w-full">
            {packages.map((pkg, idx) => (
              ...
              >
                ...
                <h3 className="font-semibold text-gray-800 text-center mb-1">{pkg.title}</h3>
                <p className="text-sm text-gray-600 text-center mb-4">{pkg.subtitle}</p>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl font-bold text-gray-900">customize your package</h2>
          </div>
          <div
          ...
          >
            <div className="flex flex-col md:flex-row items-center justify-between">
              <div className="flex-1 w-full md:w-auto mb-8 md:mb-0">
                <img src={travelIllustration} alt="Travel Illustration" className="w-full h-auto max-w-md mx-auto" />
              </div>
              <div className="flex-1 md:pl-8 w-full">
                <h3 className="text-3xl font-bold text-gray-900 mb-4">Customise Now</h3>
                ...
                <div className="flex gap-4">
                  ...
                  <button className="border border-blue-500 text-blue-500 px-6 py-3 rounded-lg font-medium hover:bg-blue-50">
