        ...
        <div className="p-8 lg:p-12 flex flex-col justify-center">
          ...
          <div className="text-center mt-8">
            <p className="text-sm text-gray-500">
              Remember your password? <button onClick={handleBackToLogin} className="text-sky-600 hover:text-blue-600 font-medium transition-colors duration-200">Sign in instead</button>
            </p>
          </div>
        </div>
      </div>
