...
const LoginPage: React.FC = () => {
  ...
  const getInputBorderColor = (field: keyof LoginFormData): string => {
    ...
    if (field === 'password') {
      ...
      const colors = ['border-red-400', 'border-yellow-400', 'border-yellow-400', 'border-green-400'];
  ...
  // Handle social login
  const handleSocialLogin = (provider: 'google' | 'microsoft' | 'facebook'): void => {
      alert(`Redirecting to ${provider.charAt(0).toUpperCase() + provider.slice(1)} login...`);
    };
          ...
          <div className="relative z-10">
            ...
            <div className="w-20 h-20 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center mb-8 mx-auto">
              <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4M10 17l5-5-5-5M15 12H3"></path>
              </svg>
            </div>
            
            <h1 className="text-4xl lg:text-5xl font-bold text-white mb-6 tracking-tight">Welcome Back!</h1>
            <p className="text-white/90 text-lg leading-relaxed max-w-sm">We're excited to see you again. Enter your credentials to access your account and continue your journey.</p>
          </div>
        </div>
        ...
        <div className="p-8 lg:p-12 flex flex-col justify-center">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <input 
                  ...
                  onChange={handleInputChange}
                  className={`w-full px-4 py-3 pr-12 border-2 ${getInputBorderColor('password')} rounded-xl focus:border-sky-400 focus:ring-0 focus:outline-none transition-all duration-300 hover:border-gray-300 focus:shadow-lg focus:shadow-sky-400/10 focus:-translate-y-1`}
            ...
            <div className="flex items-center justify-between text-sm">
              ...
              <a href="#" className="text-sky-400 hover:text-blue-600 font-medium transition-colors duration-200">
                Forgot Password?
              </a>
            </div>
          ...
          <div className="grid grid-cols-2 gap-4 mb-8">
            ...
            >
              ...
              <span className="font-medium text-gray-700 group-hover:text-sky-400 transition-colors duration-200">Google</span>
            </button>
            ...
            <button
              ...
              >
                ...
                <span className="text-gray-700 group-hover:text-sky-600 transition-colors">Facebook</span>
              </button>
          </div>
          ...
          <div className="text-center text-gray-600">
            ...
            <a href="#" className="text-sky-400 hover:text-blue-600 font-semibold transition-colors duration-200 hover:underline ml-1">
              Sign up here
            </a>
          </div>
        </div>
