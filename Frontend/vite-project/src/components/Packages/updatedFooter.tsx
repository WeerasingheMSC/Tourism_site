  ...
  <footer className="bg-gray-900 text-white py-12">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-row items-center">
      ...
      <div className="w-1/2 mb-8">
        <h3 className="text-3xl font-bold text-blue-400 mb-4">Travel Booking SriLanka</h3>
        <p className="text-gray-400 max-w-md">Book your trip in minute, get full Control for much longer.</p>
      </div>
      {/* Right Section */}
